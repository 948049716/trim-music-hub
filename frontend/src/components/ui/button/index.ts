...
export const buttonVariants = cva(
  "inline-flex items-center justify-center gap-2 whitespace-nowrap rounded-xl text-xs font-semibold ring-offset-background transition-[background-color,border-color,color,box-shadow,transform] duration-150 focus-visible:outline-none focus-visible:ring-2 focus-visible:ring-ring/60 focus-visible:ring-offset-2 disabled:pointer-events-none disabled:opacity-45 select-none cursor-pointer active:translate-y-px touch-manipulation [&_svg]:pointer-events-none [&_svg]:shrink-0",
  {
    variants: {
      variant: {
        ...
        success: "border border-success/80 bg-success text-success-foreground shadow-sm hover:bg-success/90",
        successOutline: "border border-success/25 bg-success/[0.08] text-success hover:bg-success/[0.15]",
